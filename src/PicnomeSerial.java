 ...
 *
 * PicnomeSerial.java,v.1.3.12test 2010/03/02
 */
...
public class PicnomeSerial extends JFrame implements ActionListener, ChangeListener {
  ...
  public static void main(String[] args) {
    ...
    psgui.mdf.init();
    psgui.mdf.setBounds(470, 40, 990, 665);
  ...
  public void init() {
    ...
    osc_sl.putConstraint(SpringLayout.NORTH, this.pserial.hostaddress_tf, -4, SpringLayout.NORTH, hostaddress_l);
    ...
    osc_sl.putConstraint(SpringLayout.NORTH, this.pserial.hostport_tf, -4, SpringLayout.NORTH, hostport_l);
    ...
    osc_sl.putConstraint(SpringLayout.WEST, listenport_l, 33, SpringLayout.WEST, osc_p);
    osc_p.add(listenport_l);

    this.pserial.listenport_tf = new JTextField("8080", 3);
    osc_sl.putConstraint(SpringLayout.NORTH, this.pserial.listenport_tf, -4, SpringLayout.NORTH, listenport_l);
    ...
    ds_sl.putConstraint(SpringLayout.WEST, this.pserial.led_clear_b, 60, SpringLayout.EAST, this.pserial.intensity_s);
